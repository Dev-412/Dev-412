...
INFO = [
    ("__header__", "Dev Patel", ""),
    ("__rule__", "", ""),
    ("Role",     "Student At LJ University, Ahmedabad", "val"),
    ("Edu",      "B.E. CSE, LJIET Ahmedabad", "val"),
    ("Focus",    "Backend Engineering  ·  Logic Development", "accent"),
    ("__blank__", "", ""),
    ("__section__", "~/stack", ""),
    ("Lang",     "Python · Java · JavaScript · SQL", "val"),
    ("Backend",  "Django · Flask · Node.js", "val"),
    ("Data",     "PostgreSQL · MongoDB", "val"),
    ("__blank__", "", ""),
    ("__section__", "~/projects", ""),
    ("HUSH",     "Autonomous multi-agent SRE incident response", "warn"),
    ("",         "incident resolution: ~30 min  ->  < 2 min", "muted"),
    ("CogniLearn", "AI skilling + interview prep platform", "warn"),
    ("FuelWatch", "CrewAI multi-agent theft detection · 97% acc", "warn"),
    ("MediGuide", "ML health assistant · Springer LNNS (Scopus)", "warn"),
    ("__blank__", "", ""),
    
    ("__section__", "~/reach", ""),
    ("Web",      "https://github.com/Dev-412", "accent"),
    ("In",       "https://www.linkedin.com/in/dev-patel-3381a5354/", "accent"),
    ("Mail",     "dev30112010@gmail.com", "accent"),
]
